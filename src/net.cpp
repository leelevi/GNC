...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GNC " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"GNCtools.com", "39.77.27.166"},
{"GNC-coin.com","47.104.148.77"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"GNCtools.com", "testnet-seed.GNCtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GNC is probably already running."), addrBind.ToString().c_str());
        else
